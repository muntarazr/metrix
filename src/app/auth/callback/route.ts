...
export async function GET(request: Request) {
  ...
  // `next` lets flows like password recovery land on their own page instead of home.
  // Only relative paths are honoured, so the param can't be used as an open redirect.
