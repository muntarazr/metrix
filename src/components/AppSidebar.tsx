                    ...
                    <SidebarMenuItem>
                        <SidebarMenuButton size="lg" className="group">
                            {user?.user_metadata?.avatar_url ? (
                                ...
                                <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-gradient-to-tr from-primary to-primary/60 text-primary-foreground font-semibold">
