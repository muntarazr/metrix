      ...
      <DialogContent className="sm:max-w-[420px]" dir={isArabic ? 'rtl' : 'ltr'}>
        ...
        <DialogFooter className={cn(isArabic && 'sm:flex-row-reverse sm:space-x-reverse')}>
          ...
          <button
            ...
            className="flex h-10 items-center justify-center gap-1.5 rounded-xl border border-destructive/45 bg-destructive/12 px-3 text-sm font-semibold text-destructive hover:bg-destructive/20 disabled:opacity-60"
          >
