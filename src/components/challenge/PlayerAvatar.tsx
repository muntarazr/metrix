...
export function PlayerAvatar({ avatarUrl, displayName }: PlayerAvatarProps) {
  ...
  return (
    <div className="flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-border bg-muted/60 text-sm font-black text-foreground">
