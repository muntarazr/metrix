              ...
              {filteredHierarchy.map((main) => {
                ...
                return (
                  <div
                    key={main.id}
                    className={cn(
                      "group/main overflow-hidden rounded-2xl border border-border/70 bg-card shadow-xs transition-[box-shadow,border-color] duration-200 hover:shadow-sm dark:bg-card dark:shadow-xs",
                      ...
                      <div className="flex flex-col">
                        ...
                        >
                          <div className="overflow-hidden">
                                    ...
                                    >
                                      <button
                                        ...
                                        className={cn(
                                          ...
                                          checked
                                            ? "border-transparent bg-primary/8 shadow-sm"
                                            : "border-border/70 bg-background hover:bg-muted/60 dark:bg-background/60",
                                        )}
                                      >
                                        {checked ? (
                                          <CheckSquare
                            ...
                            {composerVisible && (
                              <div className="mt-3 rounded-xl border border-dashed border-border/70 bg-card p-3 dark:bg-card/12 animate-in fade-in slide-in-from-top-2 duration-200 ease-out-quart">
