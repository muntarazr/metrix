...
export default function ToastNotification({ message, visible }: ToastNotificationProps) {
  return (
    ...
    >
      <div className="bg-primary text-primary-foreground px-5 py-3 rounded-2xl shadow-xl shadow-primary/12 border border-primary/25 font-bold text-sm flex items-center gap-2.5 max-w-[90vw] backdrop-blur-sm">
