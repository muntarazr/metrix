...
export default function GoalTemplates({ onSelectTemplate, language = 'ar' }: GoalTemplatesProps) {
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                isActive
                                    ...
                                    : "bg-card text-muted-foreground border-border hover:bg-card hover:text-foreground",
                  ...
                  {filteredTemplates.map((template) => {
                      ...
                      return (
                          <button
                              ...
                              className={cn(
                                  "group relative flex flex-col justify-start bg-card hover:bg-card border border-border hover:border-primary/45 rounded-lg p-2 transition-all hover:shadow-md text-start h-full",
                              )}
                          >
                              <div className="w-full">
                                  {/* Header: Icon + Title + Chevron in one row */}
                                  <div className="flex items-start gap-2">
                                      <div className="shrink-0 w-7 h-7 rounded-md bg-primary/12 text-primary flex items-center justify-center border border-primary/25 group-hover:scale-105 transition-transform">
                                      ...
                                      <div className="flex-1 min-w-0">
                                          ...
                                          <div className="flex items-center gap-1.5">
                                              <span className={cn(
                                                  "bg-muted/60 px-1.5 py-0.5 rounded text-muted-foreground font-medium border border-border/70 leading-none",
                                                  isArabic ? "text-[10px]" : "text-[9px]"
                                              )}>
