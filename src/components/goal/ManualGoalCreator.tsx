...
export default function ManualGoalCreator({
    ...
    const renderStepContent = () => {
        if (step === 'DETAILS') {
            return (
                <Card className="overflow-hidden border-border bg-gradient-to-br from-card via-card to-muted/20 shadow-md p-0 gap-0">
                    <CardHeader className="border-b border-border bg-muted/20 px-6 py-6">
                        ...
                        <div className="space-y-5 rounded-3xl border border-border bg-card p-5 shadow-sm">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className={cn(
                                        'h-12 rounded-2xl border-border bg-card px-4 text-sm shadow-sm',
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    className={cn(
                                        'min-h-[160px] rounded-2xl border-border bg-card px-4 py-3 text-sm leading-7 shadow-sm',
                                        isArabic ? 'text-right' : 'text-left'
                                    )}
                                    dir={isArabic ? 'rtl' : 'ltr'}
                                />
                            ...
                            <div className="space-y-2">
                                ...
                                <Popover>
                                    <PopoverTrigger asChild>
                                        ...
                                        >
                                            <Calendar className="size-4 text-primary/75 shrink-0" />
                                            <span>
                                                {startDate
                            ...
                            {mainTasks.map((main, mainIdx) => {
                                ...
                                return (
                                    <AccordionItem
                                        key={main.id}
                                        value={main.id}
                                        className="overflow-hidden rounded-[1.75rem] border border-border bg-gradient-to-br from-background via-background to-muted/20 px-0 shadow-[0_18px_40px_-32px_color-mix(in_oklch,var(--foreground)_45%,transparent)] transition-colors data-[state=open]:border-primary/25"
                                    >
                                        <AccordionTrigger
                                            className={cn(
                                        ...
                                        <AccordionContent className="border-t border-border bg-muted/12 px-4 pb-4 pt-4 sm:px-5 sm:pb-5">
                                            <div className="space-y-4">
                                                <div className="grid gap-4 xl:grid-cols-[minmax(0,1.35fr)_minmax(17rem,0.85fr)]">
                                                    <div className="space-y-4 rounded-[1.5rem] border border-border bg-card p-4 shadow-sm">
                                                        <div className="space-y-2">
                                                            ...
                                                            <Input
                                                                ...
                                                                dir={isArabic ? 'rtl' : 'ltr'}
                                                                className={cn(
                                                                    'h-11 rounded-2xl border-border bg-card px-4 shadow-sm',
                                                                    isArabic ? 'text-right' : 'text-left'
                                                                )}
                                                            />
                                                        </div>
                                                    ...
                                                    <div className="space-y-4 rounded-[1.5rem] border border-border bg-muted/20 p-4">
                                                        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
                                                            <div className="space-y-2">
                                                                ...
                                                                >
                                                                    <SelectTrigger className="h-11 w-full rounded-2xl border-border bg-card px-4 text-sm shadow-sm">
                                                                        <SelectValue />
                                                                    </SelectTrigger>
                                                                    <SelectContent>
                                                ...
                                                <div className="rounded-[1.5rem] border border-border bg-card p-4 shadow-sm">
                                                    ...
                                                    <div className="mt-4 space-y-3">
                                                        {main.subtasks.length === 0 && (
                                                            <div className="rounded-[1.25rem] border border-dashed border-border bg-muted/12 px-4 py-5 text-center text-sm text-muted-foreground">
                                                                {isArabic
                                                        ...
                                                        {main.subtasks.map((sub, subIdx) => (
                                                            <Card
                                                                key={sub.id}
                                                                className="gap-0 overflow-hidden rounded-[1.25rem] border border-border bg-muted/12 py-0 shadow-none"
                                                            >
                                                                    ...
                                                                    <div className="flex flex-col gap-4">
                                                                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                                                            ...
                                                                            <Button
                                                                                variant="ghost"
                                                                                size="icon-sm"
                                                                                className="self-end rounded-xl text-destructive hover:bg-destructive/12 hover:text-destructive sm:self-start"
                                                                        ...
                                                                        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
                                                                            <div className="space-y-2">
                                                                                ...
                                                                                <Input
                                                                                    ...
                                                                                    className={cn(
                                                                                        'h-10 rounded-xl border-border bg-card px-3 text-sm shadow-sm',
                                                                                        isArabic ? 'text-right' : 'text-left'
                                                                                    )}
                                                                                    dir={isArabic ? 'rtl' : 'ltr'}
                                                                                />
                                                                        ...
                                                                        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-[minmax(0,0.75fr)_minmax(0,0.55fr)_minmax(0,1fr)]">
                                                                            <div className="space-y-2">
                                                                                ...
                                                                                >
                                                                                    <SelectTrigger className="h-10 w-full rounded-xl border-border bg-card px-3 text-xs shadow-sm">
                                                                                        <SelectValue />
                                                                                    </SelectTrigger>
                                                                                    <SelectContent>
                                                                                        <SelectItem value="daily">
                                                                            ...
                                                                            <div className="space-y-2">
                                                                                ...
                                                                                <Input
                                                                                    ...
                                                                                    className={cn(
                                                                                        'h-10 rounded-xl border-border bg-card px-3 text-xs shadow-sm',
                                                                                        isArabic ? 'text-right' : 'text-left'
                                                                                    )}
                            ...
                            return (
                                <div key={main.id} className="rounded-2xl border bg-muted/20 px-4 py-4 space-y-3">
                                    ...
                                    {main.completion_criteria.trim() && (
                                        <div className="rounded-xl bg-background px-3 py-2 text-sm text-foreground/75">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {subtasks.length === 0 ? (
                                            ...
                                            subtasks.map((sub, subIndex) => (
                                                <div
                                                    key={sub.id}
                                                    className="rounded-xl border bg-background px-3 py-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between"
                                                >
                                                    <div className="min-w-0">
    ...
    return (
        <div className="space-y-5 max-w-full overflow-x-hidden" dir={isArabic ? 'rtl' : 'ltr'}>
            ...
            {stepError && (
                <div className="rounded-2xl border border-destructive/25 bg-destructive/12 px-4 py-3 text-sm text-destructive">
                    {stepError}
                </div>
            )}
