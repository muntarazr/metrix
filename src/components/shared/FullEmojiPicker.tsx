...
export default function FullEmojiPicker({ onSelect, value, language = 'ar', children }: FullEmojiPickerProps) {
          ...
          {TASK_EMOJI_CATEGORIES.map((category) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border text-base transition-all hover:bg-muted/60',
                  isSelected
                    ? 'border-primary/25 bg-primary/12 shadow-sm shadow-primary/12'
          ...
          {emojiOptions.map((emoji) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'relative flex h-10 w-full items-center justify-center rounded-xl border text-[18px] transition-all hover:-translate-y-0.5 hover:bg-muted/60',
                  isSelected
                    ? 'border-primary/25 bg-primary/12 shadow-sm shadow-primary/12'
